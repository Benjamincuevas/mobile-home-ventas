...
4. **Sin localStorage/sessionStorage** en el flujo principal: la persistencia es vía exportar/importar `data.js` (decisión deliberada: las fotos base64 exceden cuotas de storage y el archivo debe viajar al hosting).
